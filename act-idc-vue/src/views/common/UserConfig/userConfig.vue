    ...
    <section v-if="showConfig">
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            ...
            <el-form :inline="true" :model="filters" ref="filters">
                ...
                <el-form :inline="true">
                    <el-form-item>
                        <el-button type="success" @click="handleSave('')" icon="el-icon-plus" size="small"
                                   title="新增" plain>
                            新增
                        </el-button>
                    </el-form-item>
        ...
        <el-table :data="dataList" :height="tableHigth" v-loading="listLoading" @selection-change="selsChange"
            ...
            <el-table-column label="操作" width="140" header-align="center" align="center">
                <template slot-scope="scope">
                    <el-button-group>
                        <el-button  type="primary" @click="handleSave(scope.row.userId)" icon="el-icon-edit" title="编辑" size="mini"></el-button>
        ...
        <!--修改密码-->
        <el-dialog title="修改密码" :visible.sync="editPwVisible" label-suffix=":" :close-on-click-modal="false" size="large">
...
<script>
    ...
    import {pagingList, remove, editPw} from './userConfig.api'
